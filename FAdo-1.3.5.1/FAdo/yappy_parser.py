...
class CFGrammar(object):
    ...
    def __init__(self, grammar):
        ...
        A: list of rule index
        i.e. ntr: {'T_': [4, 5], 'E': [0], 'F': [6, 7], '@S': [8], 'E_': [1, 2], 'T': [3]}
        """
    ...
    def FIRST(self, s):
        ...
        # if first:  print '{} first {} : {}'.format( self.__str__(), s , first  ) 
                ...
                for i1 in self.ntr[s]:
                    ...
                    for i1 in range(len(r)):
                        if r[i1] in self.terminals:
                            if i1 < len(r) - 1:
                                if self.derive_ter.has_key(r[i1 + 1]):
                            ...
                            """ non-terminal"""
                            if self.derive_ter.has_key(r[i1]):
                                if not self.derive_ter.has_key(s):
                                    self.derive_ter[s] = Set([])
...
class Yappy(LRparser):
    ...
    def input(self, str=None, context={}, lexer=0):
        ...
        # print  "yappy parser input: " ,    str, context, lexer 
