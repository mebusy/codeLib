...
class SemiDFA(Drawable):
    ...
    def dotDrawTransition(st1, lbl1, st2, sep="\n"):
        ...
        :param str sep: separator
        :rtype: str """
        lbl1 = RE_PATTERN.sub( r'\\\1\2' ,  lbl1  )
        lbl1 = lbl1.replace( "\n" ,  "¿" )
...
class OFA(FA):
    ...
    def dotDrawTransition(st1, label, st2, sep="\n"):
        ...
        :param str sep: separator
        :rtype: str"""
        label = RE_PATTERN.sub( r'\\\1\2' ,  label  )
        label = label.replace( "\n" ,  "¿" )
...
class NFA(OFA):
    ...
    def evalSymbol(self, stil, sym):
        ...
        :param set|list stil: set of current states (index)
        ...
        for s in stil:
            try:
                ...
                #print 'evalSymbol' , KeyError , s , sym 
                #print self.delta
                ls = set()
            except NameError:
                #print 'evalSymbol' , NameError , s , sym 
                #print self.delta
                ls = set()
            for t in ls:
