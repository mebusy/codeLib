...
(define tests
  (test-suite
   ...
   (check-equal? (stream-for-n-steps dan-then-dog 2) (list "dan.jpg" "dog.jpg") "dan-then-dog test1")
   (check-equal? (stream-for-n-steps dan-then-dog 3) (list "dan.jpg" "dog.jpg" "dan.jpg") "dan-then-dog test2")
   ...
   (check-equal? (vector-assoc 4 (vector (cons 2 1) (cons 3 1) 4 (cons 5 1))) #f "vector-assoc test")
   (check-equal? (vector-assoc 3 (vector (cons 1 2) (cons 3 4)  )) #f "vector-assoc test")
