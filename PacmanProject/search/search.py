...
def uniformCostSearch(problem):
    ...
    #print "Start's successors:", problem.getSuccessors(problem.getStartState())
    # Q3
    return graphSearch(problem, util.PriorityQueueWithFunction(lambda item: item[2] ) )
...
def aStarSearch(problem, heuristic=nullHeuristic):
    ...
    "*** YOUR CODE HERE ***"
    #util.raiseNotDefined() 
    return graphSearch(problem, util.PriorityQueueWithFunction(lambda item: item[2]+heuristic(item[0],problem)) )
