...
#if USE_AUTO_SAVE
    //qibinyi, auto save
    if( (rogue.depthLevel>1 || rogue.deepestLevel>1)&& strcmp(AUTO_SAVE_FILENAME, currentFilePath) !=0 )
        cp(  currentFilePath , AUTO_SAVE_FILENAME  );
#endif
