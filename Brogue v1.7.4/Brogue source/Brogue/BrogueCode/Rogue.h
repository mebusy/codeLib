...
#define AUTO_SAVE_FILENAME "autosave.broguesave"

#define USE_GLYPH

#if TOUCH_SCREEN

    //#ifndef NO_FILENAME_CONFIRM
    //    #define NO_FILENAME_CONFIRM 1
    //#endif

    #ifndef DISABLE_KEYBOARD_LABEL
        #define DISABLE_KEYBOARD_LABEL 1
    #endif
        ...
        #define NO_MOUSE_MOVE 1
    #endif

#endif


//#define WORKING_FOLDER_SETTED
...
#define D_INSPECT_LEVELGEN				1 //(DEBUGGING && 0)
#define D_INSPECT_MACHINES				1 //(DEBUGGING && 0)
...
#ifdef USE_GLYPH
    //qibinyi
    enum monsterTypes u3d_monsterID;
    boolean isOverlay ;
#endif
...
extern "C" {
	...
	boolean moveCursor(boolean *targetConfirmed,
					   ...
					   boolean targetCanLeaveMap , short* pathDestination );
